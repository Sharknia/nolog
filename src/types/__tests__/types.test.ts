...
// FILEPATH: /Users/furychick/WorkSpace/blogging/Notion-to-Markdown/src/types/types.test.ts

import { PropertyValue } from '../types';

describe('PropertyValue', () => {
    it('should be a string or string[]', () => {
        const value1: PropertyValue = 'test';
        const value2: PropertyValue = ['test1', 'test2'];
