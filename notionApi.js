...
dotenv.config();
var pageId = process.env.NOTION_PAGE_ID;
var key = process.env.NOTION_KEY;
var notion = new client_1.Client({ auth: key });
(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, notion.databases.query({ database_id: pageId })];
            case 1:
                response = _a.sent();
                response.results.forEach(function (page) {
                    (function () { return __awaiter(void 0, void 0, void 0, function () {
                        var pageId, pageResponse;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    pageId = page.id;
                                ...
                                case 1:
                                    ...
                                    (function () { return __awaiter(void 0, void 0, void 0, function () {
                                        var blockId, blockResponse;
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0:
                                                    blockId = pageId;
                                                    return [4 /*yield*/, notion.blocks.retrieve({
                                                            block_id: blockId,
                                                        })];
                                                case 1:
                                    ...
                                    (function () { return __awaiter(void 0, void 0, void 0, function () {
                                        var blockId, childrenListResponse;
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0:
                                                    blockId = pageId;
            ...
            case 2:
                error_1 = _a.sent();
                console.error("Error querying the database:", error_1);
                return [3 /*break*/, 3];
